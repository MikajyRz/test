...
echo ======================================
echo Test de mapping des contrôleurs
echo ======================================
echo Ce test va scanner les contrôleurs et afficher
echo les URLs complètes construites à partir des annotations
echo.
...
echo.
echo 3) Exécution du scanner de mapping...
echo ======================================
echo Le scanner va trouver tous les contrôleurs et leurs méthodes
echo annotées avec @ControllerAnnotation et @HandleUrl
echo.
echo ======================================
java -cp "%TEST_BUILD%;%FRAMEWORK_JAR%" test.java.ControllerAnnotationScanner
echo ======================================
echo.
